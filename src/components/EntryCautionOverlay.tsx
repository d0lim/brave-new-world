      ...
      <div className="entry-terminal-boot__panel relative my-auto w-full max-w-xl">
        <div className="mb-3 flex items-center justify-between gap-2">
            ...
            <button
              ...
              className={`rounded border px-2.5 py-1 text-[10px] font-medium tracking-wide transition font-en ${
                lang === "en"
                  ...
                  : "border-slate-600/40 bg-black/40 text-slate-500 hover:border-emerald-400/30 hover:text-emerald-100/80"
              }`}
            >
              EN
            </button>
          ...
          <button
            ...
            className="shrink-0 rounded border border-slate-600/40 bg-black/40 px-2 py-1 text-[9px] font-medium tracking-wide text-slate-500 transition hover:border-emerald-400/30 hover:text-emerald-100/80"
          >
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`}
        ...
        <h1
          ...
          className="mt-4 text-center font-data-mono text-[11px] tracking-[0.2em] text-emerald-300/90 sm:text-xs"
        >
          {t("entryCautionTitle", lang)}
        </h1>
        <p className="mt-1.5 text-center text-[12px] leading-relaxed text-emerald-100/75 sm:text-[13px]">
        ...
        <ol className="mt-5 space-y-3">
          ...
          <li className="entry-terminal-boot__phase">
            ...
            <p className="mt-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-emerald-400/70">
