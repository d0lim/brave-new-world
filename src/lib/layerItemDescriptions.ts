...
export const LAYER_ITEM_DESCRIPTIONS: Partial<Record<string, string>> = {
  ...
  "gem-coal-plants": "켜면 GEM 석탄 발전 유닛을 표시합니다.",
  "gem-coal-mines": "켜면 GEM 석탄 광산을 표시합니다.",
  "gem-coal-terminals": "켜면 GEM 석탄 터미널을 표시합니다.",
  "gem-nuclear": "켜면 GEM 원자력 발전 유닛을 표시합니다.",
  "gem-solar": "켜면 GEM 유틸리티급 태양광을 표시합니다.",
  "gem-wind": "켜면 GEM 풍력 단지를 표시합니다.",
  "gem-hydro": "켜면 GEM 수력 발전을 표시합니다.",
  "gem-geothermal": "켜면 GEM 지열 발전을 표시합니다.",
  "gem-bioenergy": "켜면 GEM 바이오에너지 발전을 표시합니다.",
  "gem-oil-gas-plants": "켜면 GEM 오일·가스 화력 발전을 표시합니다.",
  "gem-oil-gas-extraction": "켜면 GEM 오일·가스 채굴 필드를 표시합니다.",
  "gem-iron-ore": "켜면 GEM 철광산을 표시합니다.",
  "gem-cement": "켜면 GEM 시멘트 플랜트를 표시합니다.",
  "gem-steel": "켜면 GEM 철강 플랜트를 표시합니다.",
  "gem-chemicals": "켜면 GEM 화학 플랜트를 표시합니다.",
