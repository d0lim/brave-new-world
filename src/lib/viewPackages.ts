...
export const LAYER_PREF_LABELS: Partial<Record<BooleanLayerKey, string>> = {
  ...
  showGdeltOceanCompetition: "대양 지정학 뉴스",
  showTelegramOsint: "텔레그램 OSINT",
  showUkraineControl: "우크라이나 전선",
  showNeptun: "(우크라) 실측 · 미사일·드론 현위치 + 궤적",
  ...
  showChinaPhilippinesIncidents: "중국↔필리핀 해상충돌",
  showUsChinaIncidents: "미국↔중국 군사마찰",
  showNorthKoreaMissileTests: "북한 미사일·무기시험 (발생지)",
